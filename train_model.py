...
def train_model():
    """Main function to train the LLM model."""
    ...
    # Create the initial embedding matrix: [vocab_size, embed_dim]
    vocab_size = 96
    embed_dim = 32
    ...
    # Token embedding: Convert token IDs to embeddings using the initial embedding matrix
